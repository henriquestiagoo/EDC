<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MostReviews.aspx.cs" Inherits="EDC_ProjetoFinal.MostReviews" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <br />
    <hr />
    <h4>Most Reviewed Movies:</h4>
    <hr />

    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" 
        SelectCommand="MostReviewedMovies" 
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" GridLines="None" DataSourceID="SqlDataSource1" CssClass="table table-striped">
        <EmptyDataTemplate>
            <div class="panel panel-warning">
                <div class="panel-heading"><h3 class="panel-title">No User has made Reviews so Far!!</h3></div>
        ...
        <Columns>
            ...
            <asp:BoundField DataField="NrReviews">
                <ItemStyle HorizontalAlign="right" VerticalAlign="Middle" />
            </asp:BoundField>
            <asp:BoundField DataField="Reviews">
