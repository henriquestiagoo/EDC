<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MoviesTrailers.aspx.cs" Inherits="EDC_ProjetoFinal.MoviesTrailers" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" OnRowDataBound="GridView1_RowDataBound" AutoGenerateColumns="False" AllowPaging="True" GridLines="None" CssClass="table table-striped">
        ...
        <Columns>
        <asp:TemplateField HeaderText="Latest Movie Trailers" >
            <ItemTemplate>
                <br />
